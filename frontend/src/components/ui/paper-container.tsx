        ...
        <div className="bg-card border border-gray-200 shadow-lg rounded-lg p-6">
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-1">
                    ...
                    <Button variant="purple" size="default" onClick={() => window.open("https://www.semanticscholar.org/paper/LoRA%3A-Low-Rank-Adaptation-of-Large-Language-Models-Hu-Shen/a8ca46b171467ceb2d7652fbfb67fe701ad86092", '_blank')}>
                        Full Text
                    </Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-16 rounded-lg p-4 mb-4">
                ...
                <div>
                    <iframe src="https://arxiv.org/pdf/2106.09685" title="Paper" className='w-full h-full' />
                </div>
            </div>
        </div>
    );
